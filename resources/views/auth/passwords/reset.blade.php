        ...
        <div class="position-relative z-1 w-100" style="max-width:320px;">
            <div class="feature-item">
                <div class="feature-icon">
                    <i class="fa-solid fa-lock-open" style="color:#a5d6a7;font-size:16px;"></i>
                </div>
                <div>
                    <div class="text-white fw-semibold fs-14">Set a New Password</div>
                    <div style="color:rgba(255,255,255,0.6);font-size:12px;">Choose a strong, unique password</div>
                </div>
            </div>
            <div class="feature-item">
                <div class="feature-icon">
                    <i class="fa-solid fa-shield-halved" style="color:#a5d6a7;font-size:16px;"></i>
                </div>
                <div>
                    <div class="text-white fw-semibold fs-14">Account Protected</div>
                    <div style="color:rgba(255,255,255,0.6);font-size:12px;">Your data is encrypted and secure</div>
                </div>
            </div>
            <div class="feature-item">
                <div class="feature-icon">
        ...
        <div class="auth-card">
            ...
            <div class="text-center mb-4">
                <div class="d-inline-flex align-items-center justify-content-center rounded-circle mb-3"
                    ...
                    <i class="fa-solid fa-lock-open" style="color:#2d6a2d;font-size:20px;"></i>
                </div>
                <h4 class="fw-bold text-dark mb-1" style="font-size:22px;">Reset Password</h4>
                <p class="text-muted fs-14 mb-0">Enter your new password below</p>
            </div>
