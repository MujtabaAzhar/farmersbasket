          ...
          <div class="login-form">
            <form method="POST" action="{{ route('login') }}" name="login-form" class="needs-validation" novalidate="">
              ...
              <div class="customer-option mt-4 text-center">
                ...
                <a href="{{route('register')}}" class="btn-text js-show-register">Create Account</a> | <a href="{{route('password.request')}}" class="btn-text js-show-register">Forget Password?</a>
              </div>
            </form>
          </div>
        </div>
