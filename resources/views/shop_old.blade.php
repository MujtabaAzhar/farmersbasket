...
{{-- 
                                        ...
                                        <li class="list-item">
                                            <span class="menu-link py-1">
                                                <input type="checkbox" name="brands" value="{{ $brand->id }}"
                                                    id="brand-{{ $brand->id }}" class="chk-brand"
                    ...
                    <div class="accordion-item mb-4">
                        ...
                        <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                            ...
                            <input class="price-range-slider" type="text" name="price_range" value=""
                                data-slider-min="10" data-slider-max="10000" data-slider-step="500"
            ...
            "pagination": {
              ...
              "clickable": true
                                                ...
                                                @foreach (explode(',', $product->images) as $galleryImage)
                                                    <div class="swiper-slide">
                                                        <a
                                                            href="{{ route('shop.product.details', ['product_slug' => $product->slug]) }}"><img
                                                                loading="lazy"
                                                                src="{{ asset('uploads/products/' . trim($galleryImage)) }}"
                                                                width="330" height="400" alt="{{ $product->name }}"
                                                                class="pc__img"></a>
                                                    </div>
                                                @endforeach
                ...
                <div class="flex items-center justify-between flex-wrap gap10 wgp-paginaion">
