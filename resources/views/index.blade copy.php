...
{{-- 
        <div class="swiper-slide">
          <div class="overflow-hidden position-relative h-100">
            <div class="slideshow-character position-absolute bottom-0 pos_right-center">
              <img loading="lazy" src="{{ asset('assets/images/slideshow-character11.png') }}" width="400" height="733"
                alt="Woman Fashion 1"
                class="slideshow-character__img animate animate_fade animate_btt animate_delay-9 w-auto h-auto" />
              <div class="character_markup type2">
                <p
            ...
            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
              ...
              <h2 class="h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5">MIX / LASOORA</h2>
              <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">ACHAAR</h2>
              <a href="#"
                class="btn-link btn-link_lg default-underline fw-medium animate animate_fade animate_btt animate_delay-7">Shop
                Now</a>
            </div>
          ...
          <div class="overflow-hidden position-relative h-100">
            ...
            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
              <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">
                {{-- New Arrivals --}}
         {{--   </h6>
              <h2 class="h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5">Mangoes</h2>
              <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">Aam Ka Janoon</h2>
              <a href="#"
                class="btn-link btn-link_lg default-underline fw-medium animate animate_fade animate_btt animate_delay-7">Shop
                Now</a>
            </div>
      ...
      <section class="hot-deals container">
        ...
        <div class="row">
          <div
            ...
            <h2>Summer Sale</h2>
            <h2 class="fw-bold">Up to 10% Off</h2>
                  ...
                  <div class="swiper-slide product-card product-card_style3">
                    <div class="pc__img-wrapper">
                      <a href="{{ route('shop.product.details', ['product_slug' => $sproduct->slug]) }}">
                        ...
                        <img loading="lazy" src="{{ asset('uploads/products/' . $sproduct->image) }}" width="258" height="313"
                          alt="{{ $sproduct->name }}" class="pc__img pc__img-second">
                      </a>
                    </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="category-banner__item border-radius-10 mb-5">
              <img loading="lazy" class="h-auto" src="{{ asset('uploads/categories/' . $category_2->image) }}" width="690" height="665"
                alt="" />
              <div class="category-banner__item-mark">
                Starting at Rs {{ $category_2->products()->min('regular_price') }}
              </div>
              <div class="category-banner__item-content">
                <h3 class="mb-0">{{ $category_2->name }}</h3>
                <a href="{{ route('shop.index', ['categories' => $category_2->id]) }}" class="btn-link default-underline text-uppercase fw-medium">Shop Now</a>
              </div>
            </div>
          </div>
            @endforeach
